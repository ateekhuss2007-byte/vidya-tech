    ...
    <div className="w-full fluid-container py-6 sm:py-10 animate-fade-in space-y-8">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <motion.button
          ...
          className="px-5 py-2.5 rounded-xl bg-[#007AFF] hover:bg-[#5EFCC2] text-white font-bold text-xs sm:text-sm shadow-md shadow-[#007AFF]/20 flex items-center gap-2"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-5 rounded-2xl bg-white dark:bg-white dark:bg-[#1D1D1F] border border-slate-200/80 dark:border-[#AAAAAA]/30 dark:border-white/[0.08] shadow-sm">
      ...
      <div className="p-6 sm:p-8 rounded-2xl bg-white dark:bg-white dark:bg-[#1D1D1F] border border-slate-200/80 dark:border-[#AAAAAA]/30 dark:border-white/[0.08] shadow-sm">
        <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-100 dark:border-[#AAAAAA]/30 dark:border-white/[0.08]">
          ...
          <button
            onClick={handleReset}
            className="text-xs text-slate-400 dark:text-[#8B949E] hover:text-[#007AFF] flex items-center gap-1 font-medium transition-colors"
          >
        ...
        <div className="mt-8 p-5 rounded-xl bg-emerald-50/80 dark:bg-[#007AFF]/5 border border-emerald-100 dark:border-[#007AFF]/20 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <button
            onClick={handleReinforce}
            className="px-4 py-2 rounded-xl bg-[#007AFF] hover:bg-[#5EFCC2] text-white font-bold text-xs shrink-0 shadow-sm"
          >
            Review Now
          </button>
        </div>
