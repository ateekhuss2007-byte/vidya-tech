...
export const ModernHero = ({ setActiveTab, onOpenAuth, user, onExploreMore }) => {
  ...
  return (
    <section id="hero" className="w-full bg-[#EAF8FD] py-6 sm:py-10 md:py-16 px-2 sm:px-4 md:px-6 lg:px-8 xl:px-10">
      ...
      <div className="w-full max-w-[96vw] xl:max-w-[1680px] 2xl:max-w-[1780px] mx-auto bg-[#FFFFFF] rounded-[42px] sm:rounded-[56px] shadow-[0_20px_60px_rgba(69,181,229,0.06)] border border-slate-200/20 dark:border-white/[0.04] overflow-hidden relative p-8 sm:p-12 md:p-16 lg:p-20 xl:p-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-12 xl:gap-16 items-center relative z-10">
          ...
          <div className="lg:col-span-6 xl:col-span-7 space-y-6 sm:space-y-8 text-left">
            ...
            >
              ...
              <button
                ...
                className="px-8 py-4 rounded-full bg-white border border-[#45B5E5]/30 hover:border-[#45B5E5]/70 text-[#168FC4] hover:bg-[#EAF8FD] font-bold text-base hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 cursor-pointer flex items-center justify-center gap-2 shadow-xs"
              >
          ...
          <div className="lg:col-span-6 xl:col-span-5 relative flex items-center justify-center">
            ...
            <motion.div
              ...
              className="relative w-full max-w-[620px] xl:max-w-[720px] 2xl:max-w-[780px] rounded-[36px] sm:rounded-[46px] overflow-hidden border border-slate-200/20 dark:border-white/[0.04] bg-white shadow-[0_30px_70px_rgba(69,181,229,0.20)] group"
            >
              <img
